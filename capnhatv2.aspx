<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="capnhatv2.aspx.cs" Inherits="test.capnhatv2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="tieude" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" runat="server">
    <form id="form1" runat="server">
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="masv" DataSourceID="SqlDataSource1" DefaultMode="Edit" OnItemInserting="FormView1_ItemInserting" OnItemUpdating="FormView1_ItemUpdating">
            <EditItemTemplate>
                masv:
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" 
            ...
            UpdateCommand="UPDATE [sinhvien] SET [hoten] = @hoten, [dienthoai] = @dienthoai, [que] = @que, [malop] = @malop, [anh] = @anh WHERE [masv] = @original_masv">
            <SelectParameters>
